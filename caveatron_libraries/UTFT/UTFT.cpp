...
// Variant that removes declaration of display model from class constructor. No latched displays.
...
// New function that allows display model to be declared in setup after loading hardware parameters. Removed latched displays.
void UTFT::setDisplayModel(byte model)
{ 
	word	dsx[] = {239, 239, 239, 239, 239, 239, 175, 175, 239, 127,		// 00-09
					 127, 239, 271, 479, 239, 239, 239, 239, 0, 239,			// 10-19
					 479, 319, 239, 175, 127, 239, 239, 319, 319, 799,		// 20-29
