...
/*
	...
	Allows option for display model to be declared seperate from constructor function
	Adds invert_colors variable
...
class UTFT
{
	public:
		...
		void	setDisplayModel(byte model);
