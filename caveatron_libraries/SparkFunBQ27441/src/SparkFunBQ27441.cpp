...
void BQ27441::setI2CPort(TwoWire &theWire)
{
	_wire = &theWire;
}
...
// Configures the design capacity of the connected battery.
bool BQ27441::setTerminateVoltage(uint16_t termVolts)
{
	// Write to STATE subclass (82) of BQ27441 extended memory.
	// Offset 0x0A (10)
	// Design capacity is a 2-byte piece of data - MSB first
	uint8_t capMSB = termVolts >> 8;
	uint8_t capLSB = termVolts & 0x00FF;
	uint8_t termVoltsData[2] = {capMSB, capLSB};
	return writeExtendedData(BQ27441_ID_STATE, 16, termVoltsData, 2);
}
// *** End Modifications for Caveatron ***
