...
/*
	...
	Restores setTerminateVoltage function from previous library release
...
public:
	...
	*/
	...
	// *** Start Modifications for Caveatron ***
	// Added this function back since it was deleted
	/**
	    Configures the terminate voltage of the connected battery.
		
		@param termVolts of battery (unsigned 16-bit value)
		@return true if terminate voltage successfully set.
	*/
	bool setTerminateVoltage(uint16_t termVolts);
	// *** End Modifications for Caveatron ***
