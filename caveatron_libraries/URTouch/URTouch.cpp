...
// Initialization with directly passed screen calibration parameters
void URTouch::InitTouch(byte orientation, unsigned long CCAL_X, unsigned long CCAL_Y, unsigned long CCAL_S)
{
	orient					= orientation;
	_default_orientation	= CCAL_S>>31;
	touch_x_left			= (CCAL_X>>14) & 0x3FFF;
	touch_x_right			= CCAL_X & 0x3FFF;
	touch_y_top				= (CCAL_Y>>14) & 0x3FFF;
	touch_y_bottom			= CCAL_Y & 0x3FFF;
	disp_x_size				= (CCAL_S>>12) & 0x0FFF;
	disp_y_size				= CCAL_S & 0x0FFF;
	prec					= 10;
